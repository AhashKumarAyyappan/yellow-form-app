  ...
  function App() {
    ...
    useEffect(() => {
      const loadWidget = async () => {
        try {
          const module = await import("https://cdn.yellowmessenger.com/yapps-sdk/v1.0.0/widget.js");
          const YAppWidget = module.YAppWidget || window.YAppWidget;
    ...
    const showProductDropdown = ticketType && ticketType !== "LoadPlan" && productOptions.length > 0;
